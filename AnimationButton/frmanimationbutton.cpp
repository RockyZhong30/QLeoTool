...
//	this->setStyleSheet(qss);
    ...
    ui->widget1->setImage(":/AnimationButton/v-home-ico-home");

	ui->widget2->setText("通讯录");
    ui->widget2->setImage(":/AnimationButton/v-home-ico-contact");

	ui->widget3->setText("图片");
    ui->widget3->setImage(":/AnimationButton/v-home-ico-img");

	ui->widget4->setText("录音");
    ui->widget4->setImage(":/AnimationButton/v-home-ico-record");
    ui->widget4->update();
}
