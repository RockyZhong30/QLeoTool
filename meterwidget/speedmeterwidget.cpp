...
void SpeedMeterWidget::setValue(qreal value)
{
    if(value == m_value)
    {
        return;
...
void SpeedMeterWidget::setRatio(qreal value)
{
    m_ratio = value;
}

void SpeedMeterWidget::setAnimating(bool enable)
{
    m_bAnimating = enable;
    update();
}

void SpeedMeterWidget::updateGraph()
{
    if(m_bReverse)
    {
        m_currentValue -= 0.5;
...
QSize SpeedMeterWidget::sizeHint() const
{
    return QSize(200, 200);
}

QSize SpeedMeterWidget::minimumSizeHint() const
{
    return QSize(100, 100);
}

void SpeedMeterWidget::initVariables()
{
    resetVariables();
...
void SpeedMeterWidget::resetVariables()
{
...
void SpeedMeterWidget::drawOuterCircle(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawInnerCircle(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawMark(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawTextRect(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawCoverCircle(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawColorPie(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawIndicator(QPainter *painter)
{
    painter->save();
...
void SpeedMeterWidget::drawCoverBall(QPainter *painter)
{
    painter->save();
