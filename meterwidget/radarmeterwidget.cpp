#include "radarmeterwidget.h"

#include <QPainter>
#include <QTimerEvent>
#include "math.h"

RadarMeterWidget::RadarMeterWidget(QWidget *parent)
    : QWidget(parent)
{
    m_pieRotate = 0;
    m_timerId = -1;
...
void RadarMeterWidget::paintEvent(QPaintEvent *event)
{
...
void RadarMeterWidget::resizeEvent(QResizeEvent *event)
{
...
void RadarMeterWidget::timerEvent(QTimerEvent *event)
{
