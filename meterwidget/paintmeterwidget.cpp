...
PaintMeterWidget::PaintMeterWidget(QWidget *parent)
    : QWidget(parent)
{
   m_precision = 0;
   m_steps = 10;
...
void PaintMeterWidget::setThreshold(double value)
{
...
void PaintMeterWidget::setValue(double value)
{
    if(value > m_maxValue)
    {
        m_value = m_maxValue;
...
void PaintMeterWidget::thresholdManager()
{
...
void PaintMeterWidget::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
...
void PaintMeterWidget::drawCrown(QPainter *painter)
{
    painter->save();
...
void PaintMeterWidget::drawBackground(QPainter *painter)
{
    painter->setBrush(m_background);
    painter->drawEllipse(-45, -45, 90, 90);
}

void PaintMeterWidget::drawTicks(QPainter *painter)
{
    painter->save();
...
void PaintMeterWidget::drawScale(QPainter *painter)
{
    painter->save();
...
void PaintMeterWidget::drawUnits(QPainter *painter)
{
    painter->setPen(m_foreground);
...
void PaintMeterWidget::drawNumericValue(QPainter *painter)
{
...
void PaintMeterWidget::drawNeedle(QPainter *painter)
{
    painter->save();
...
void PaintMeterWidget::drawThresholdLine(QPainter *painter)
{
    if(!m_thresholdEnabled)
    {
        return;
...
void PaintMeterWidget::drawCoverGlass(QPainter *painter)
{
    painter->save();
...
void PaintMeterWidget::drawLabel(QPainter *painter)
{
    painter->save();
    painter->setPen(m_foreground);
    painter->setBrush(m_foreground);
...
void PaintMeterWidget::drawWarningWindow(QPainter *painter)
{
...
void PaintMeterWidget::drawValidWindow(QPainter *painter)
{
