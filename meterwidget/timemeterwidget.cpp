#include "timemeterwidget.h"
#include <QTimer>
#include <QPainter>
#include "math.h"

TimeMeterWidget::TimeMeterWidget(QWidget *parent)
    : QWidget(parent)
{
...
void TimeMeterWidget::setValue(qreal value)
{
    m_value = value;
    update();
}

void TimeMeterWidget::drawCrown(QPainter *painter)
{
    painter->save();
...
void TimeMeterWidget::drawScale(QPainter *painter)
{
    painter->save();
...
void TimeMeterWidget::drawScaleNum(QPainter *painter)
{
    painter->save();
...
void TimeMeterWidget::drawTitle(QPainter *painter)
{
    painter->save();
    painter->setPen(m_foreground);
...
void TimeMeterWidget::drawNumericValue(QPainter *painter)
{
...
void TimeMeterWidget::drawIndicator(QPainter *painter)
{
    painter->save();
...
void TimeMeterWidget::paintEvent(QPaintEvent *event)
{
