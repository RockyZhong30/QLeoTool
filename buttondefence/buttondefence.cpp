...
ButtonDefence::ButtonDefence(QWidget *parent) : QWidget(parent)
{
    ...
    type = "police";
    imgName = QString(":/buttondefence/btn_defence_disarming_%1").arg(type);
    isDark = false;
...
{
    if (isDark) {
        imgName = QString(":/buttondefence/btn_defence_error_%1").arg(type);
    } else {
        imgName = QString(":/buttondefence/btn_defence_alarm_%1").arg(type);
    }
...
void ButtonDefence::setButtonStatus(const ButtonDefence::ButtonStatus &buttonStatus)
{
    ...
    if (buttonStatus == ButtonStatus_Arming) {
        imgName = QString(":/buttondefence/btn_defence_arming_%1").arg(type);
    } else if (buttonStatus == ButtonStatus_Disarming) {
        imgName = QString(":/buttondefence/btn_defence_disarming_%1").arg(type);
    } else if (buttonStatus == ButtonStatus_Bypass) {
        imgName = QString(":/buttondefence/btn_defence_bypass_%1").arg(type);
